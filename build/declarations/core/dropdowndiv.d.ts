 ...
 */
export declare function showPositionedByBlock<T>(field: Field<T>, block: BlockSvg, opt_onHide?: () => void, opt_secondaryYOffset?: number, manageEphemeralFocus?: boolean, autoCloseOnLostFocus?: boolean): boolean;
/**
 * Shortcut to show and place the drop-down with positioning determined
 ...
 * @returns True if the menu rendered below block; false if above.
 */
export declare function showPositionedByField<T>(field: Field<T>, opt_onHide?: () => void, opt_secondaryYOffset?: number, manageEphemeralFocus?: boolean, autoCloseOnLostFocus?: boolean): boolean;
/**
 ...
 * @internal
 */
export declare function show<T>(newOwner: Field<T>, rtl: boolean, primaryX: number, primaryY: number, secondaryX: number, secondaryY: number, manageEphemeralFocus: boolean, autoCloseOnLostFocus: boolean, opt_onHide?: () => void): boolean;
/**

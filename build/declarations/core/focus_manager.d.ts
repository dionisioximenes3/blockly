...
export declare class FocusManager {
    ...
    private ephemerallyFocusedElement;
    private ephemeralDomFocusChangedCallback;
    private ephemerallyFocusedElementCurrentlyHasFocus;
     ...
     *     should end.
     */
    takeEphemeralFocus(focusableElement: HTMLElement | SVGElement, onFocusChangedInDom?: EphemeralFocusChangedInDom | null): ReturnEphemeralFocus;
    /**

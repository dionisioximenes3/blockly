...
export function createDom() {
    ...
    keydownListener = browserEvents.conditionalBind(content, 'keydown', null, common.globalShortcutHandler);
 ...
 */
export function showPositionedByBlock(field, block, opt_onHide, opt_secondaryYOffset, manageEphemeralFocus = true, autoCloseOnLostFocus = true) {
    return showPositionedByRect(getScaledBboxOfBlock(block), field, manageEphemeralFocus, autoCloseOnLostFocus, opt_onHide, opt_secondaryYOffset);
}
/**
 * Shortcut to show and place the drop-down with positioning determined
 ...
 * @returns True if the menu rendered below block; false if above.
 */
export function showPositionedByField(field, opt_onHide, opt_secondaryYOffset, manageEphemeralFocus = true, autoCloseOnLostFocus = true) {
    positionToField = true;
    return showPositionedByRect(getScaledBboxOfField(field), field, manageEphemeralFocus, autoCloseOnLostFocus, opt_onHide, opt_secondaryYOffset);
}
/**
 ...
 * @returns True if the menu rendered below block; false if above.
 */
function showPositionedByRect(bBox, field, manageEphemeralFocus, autoCloseOnLostFocus, opt_onHide, opt_secondaryYOffset) {
    ...
    return show(field, sourceBlock.RTL, primaryX, primaryY, secondaryX, secondaryY, manageEphemeralFocus, autoCloseOnLostFocus, opt_onHide);
}
/**
 ...
 * @internal
 */
export function show(newOwner, rtl, primaryX, primaryY, secondaryX, secondaryY, manageEphemeralFocus, autoCloseOnLostFocus, opt_onHide) {
    owner = newOwner;
